...
NDiplomacy = {
	...
	EXCOMMUNICATE_ACTION_MONTHS = 24, 				-- Excommunication "cooldown" (months)
	CRUSADE_TIMEOUT_YEARS = 25, 					-- Crusade timeout (years)
	...
	EMPEROR_REVOKE_AUTHORITY_COST = 75.0,			-- Cost for the emperor to revoke a reform
	...
	HRE_VOTE_VASSAL_ELECTOR = -100,
	HRE_VOTE_TOO_SMALL = 0,
	...
	CELESTIAL_EMPIRE_MANDATE_PER_HUNDRED_NONTRIBUTARY_DEV = -0.15,	-- Yearly change of Mandate for each hundred development of neighbouring states that are not the Emperor's tributaries
...
NCountry = {
	...
	PIETY_PERCENTAGE_AT_NEW_RULER = 0.80,			-- percentage of piety kept at new ruler.
	...
	PS_REMOVE_ACCEPTED_CULTURE = 5,
	PS_REMOVE_ACCEPTED_CULTURE_UNREST_DURATION = 2.5,
	...
	MONTHS_TO_CHANGE_CULTURE = 12,					-- How many months it will take to change culture in a province, per development.
...
NAI = {
	...
	WANT_TRIBUTARY_LOST_MANDATE = 30, -- How important it is for Celestial Emperor to make tributaries out of neighbors.
	...
	ASSIMILATION_INTEREST_AMOUNT_FACTOR = 50,					-- Influence on assimilation interest from number of provinces left to conquer
...
NReligion = {
	...
	MIN_HARMONIZE_DEVELOPMENT = 10,	-- Base is 20
	STARTING_HARMONY = 50.0,							-- Confucian countries start with this.
	YEARLY_HARMONY_INCREASE = 1.0,
	HARMONY_LOSS_PER_DEV_CONVERTED = 1.0,
	YEARLY_HARMONY_INCREASE_WHEN_HARMONIZING = -2.0, -- Base game is -3%
	YEARLY_HARMONIZATION_PROGRESS = 0.05, 			-- Base game is 3%
